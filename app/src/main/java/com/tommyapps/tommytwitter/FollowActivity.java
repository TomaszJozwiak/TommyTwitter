        ...
        if(item.getItemId() == R.id.tweet) {
            ...
            builder.setPositiveButton("Send", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Toast.makeText(FollowActivity.this, tweetContentEditText.getText().toString(), Toast.LENGTH_SHORT).show();
                    ...
                    tweet.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                Toast.makeText(FollowActivity.this, "Tweet success", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(FollowActivity.this, "Tweet failed, try again later", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
